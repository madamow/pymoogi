...
class AbfindPlot(object):
    ...
    def __init__(self, org_pars):
        ...
        self.data_orig = out2_abfind(org_pars['summary_out'])  # data
    ...
    def get_title(self):
        title = open(self.org_pars['summary_out']).readlines()[2].strip()
        return title
    ...
    def switch_model(self, org_pars):
        ...
        try:
            cf.run_moog(self.driver, self.org_pars)
        except:
            print("\n No such a file")
